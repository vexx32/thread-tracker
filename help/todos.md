Titi can help keep track of your to do list! To Do list entries will also be shown when listing threads with **`/tt_threads`**, and can occupy the same categories as your normal threads.
